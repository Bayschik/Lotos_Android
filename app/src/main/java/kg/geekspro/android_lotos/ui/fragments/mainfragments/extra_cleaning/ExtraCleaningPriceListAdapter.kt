...
class ExtraCleaningPriceListAdapter(
    private val serviceList:ArrayList<CleaningService>
): RecyclerView.Adapter<ExtraCleaningPriceListAdapter.ECPriceListViewHolder>() {
    ...
    inner class ECPriceListViewHolder(private val binding: ItemPriceListBinding): RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ECPriceListViewHolder {
        return ECPriceListViewHolder(ItemPriceListBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }

    override fun getItemCount(): Int = serviceList.size

    override fun onBindViewHolder(holder: ECPriceListViewHolder, position: Int) {
