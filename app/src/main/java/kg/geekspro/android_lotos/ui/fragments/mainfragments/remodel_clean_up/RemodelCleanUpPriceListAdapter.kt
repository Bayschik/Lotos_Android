...
class RemodelCleanUpPriceListAdapter(
    private val serviceList:ArrayList<CleaningService>
): RecyclerView.Adapter<RemodelCleanUpPriceListAdapter.RemodelCleanUpPriceListViewHolder>() {
    ...
    inner class RemodelCleanUpPriceListViewHolder(private val binding: ItemPriceListBinding): RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RemodelCleanUpPriceListViewHolder {
        return RemodelCleanUpPriceListViewHolder(ItemPriceListBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }

    override fun getItemCount(): Int = serviceList.size

    override fun onBindViewHolder(holder: RemodelCleanUpPriceListViewHolder, position: Int) {
